...
plot4 <- function(){
    ...
    ## top left
    plot(x = power$Time, y = power$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "")
    
    ## top right
    plot(x = power$Time, y = power$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
    
    ## bottom left
    plot(x = power$Time, y = power$Sub_metering_1, type = "l", ylab = "Energy sub metering", xlab = "")
    ...
    ##bottom right
    plot(x = power$Time, y = power$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime")
